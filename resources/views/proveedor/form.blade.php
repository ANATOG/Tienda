<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" class="form-control" placeholder="Nombre del proveedor" id="nombre" name="nombre" required>
    </div>
</div>
...
<div class="form-group row">
    ...
    <div class="col-md-9">
        <input type="text" class="form-control" placeholder="NIT" id="nit" name="nit" required>
    </div>
</div>
